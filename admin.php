...
<body>
    ...
    <div class="middle" style="  padding:40px; border:1px solid #ED2553; margin:0px auto; width:400px;">
        <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#ED2553;border-radius:10px 10px 10px 10px;"
            role="tablist">
            <li class="nav-item">
            ...
            <a class="nav-link" id="profile-tab" style="color:white;" aria-controls="profile"
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
                ...
                <form method="post" enctype="multipart/form-data" action="dashboard.php">
                    ...
                    <button type="submit" name="login" style="background:#ED2553; border:1px solid #ED2553;"
